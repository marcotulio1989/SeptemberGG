...
export const config = {
    ...
    environment: {
        ...
        trees: {
            ...
            minDistanceFromEdgeM: 2.8,
            minDistanceFromBuildingM: 4.8,
            minDistanceBetweenTreesM: 5.6,
            baseRadiusM: 1.9,
            radiusJitterM: 0.65,
            canopyFlatten: 0.58,
            canopyColor: 0x2E7D32,
            canopyAlpha: 0.94,
            canopyEdgeColor: 0x1B5E20,
            trunkColor: 0x4E342E,
            trunkWidthM: 0.38,
            trunkHeightM: 2.6,
            shadowAlpha: 0.22,
